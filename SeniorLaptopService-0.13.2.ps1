...
function Invoke-SelfUpdate {
    ...
    $manifest = Invoke-RestMethod $manifestRequestUrl -Headers @{'User-Agent'='SeniorLaptopService-Updater/1';'Cache-Control'='no-cache'}
    ...
    Invoke-WebRequest $scriptRequestUrl -OutFile $download -UseBasicParsing -Headers @{'User-Agent'='SeniorLaptopService-Updater/1';'Cache-Control'='no-cache'}
