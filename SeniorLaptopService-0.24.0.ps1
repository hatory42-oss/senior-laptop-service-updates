...
<div class="step"><span class="num">10. Zapret: установить / обновить</span><p>Обновляет переносимую копию Zapret, удаляет прежнюю службу, устанавливает стратегию №9 и открывает тестовое видео в браузере по умолчанию, кроме Edge. Тестовые окна закрываются автоматически. Системные звуки программа не меняет.</p></div>
