...
$guideButton = Add-ActionButton 'Рекомендации по модернизации + памятка пользователю' $recommendationsAction 0 4 ([Drawing.Color]::Honeydew)
$buttons.SetColumnSpan($guideButton,3)
