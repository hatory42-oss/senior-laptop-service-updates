...
$installAdBlockAction = {
    ...
    if ($yandexInstalled) {
        ...
        Write-ServiceLog 'Яндекс Браузер: отключены уведомления новой вкладки, подсказки обучения, ротация/HD-анимация фона, боковая панель и лишние нейроэлементы; установлен спокойный статичный фон.'
